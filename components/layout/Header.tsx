        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="/carrito" className="p-2 text-neutral-700 hover:text-primary-600 transition-all duration-300 hover:bg-primary-50 rounded-lg relative">
              ...
              <span className="absolute -top-1 -right-1 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white transform bg-gradient-to-r from-neutral-800 to-neutral-900 rounded-full">
                2
              </span>
            </Link>
